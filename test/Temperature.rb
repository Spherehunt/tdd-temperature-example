...
class TemperatureTest < Minitest::Test
    ...
    def test_to_kelvin
        temperature = Temperature.new(0)
        assert_equal(273.15, temperature.to_kelvin,"0 celsius does not equal 273.15K")
    end

    def test_42_to_kelvin
        temperature = Temperature.new(42)
        assert_equal(315.15, temperature.to_kelvin,"0 celsius does not equal 315.15K")
    end
end
